...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width = \linewidth]{chapters/04-Regularization/tikz/Model Capacity.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width = 0.8\linewidth]{chapters/04-Regularization/tikz/Regularization Schema.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width = \linewidth]{chapters/04-Regularization/tikz/L1 and L2 plot.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width = 0.6\linewidth]{chapters/04-Regularization/tikz/Multi Task Learning.pdf} 
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width = \linewidth]{chapters/04-Regularization/tikz/Dropout.pdf}
