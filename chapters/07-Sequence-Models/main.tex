...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/07-Sequence-Models/tikz/Show and Tell Model.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/07-Sequence-Models/tikz/Sampling.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/07-Sequence-Models/tikz/Beam Search.pdf}
...
\; The Candidate is: "\textit{Transformers Transformers Transformers Transformers.}" \ \img{chapters/07-Sequence-Models/tikz/Optimus Prime.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/07-Sequence-Models/tikz/Show, Attend and Tell.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/07-Sequence-Models/tikz/Attention Types.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/07-Sequence-Models/tikz/Seq2Seq.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/07-Sequence-Models/tikz/RNN Enc-Dec.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/07-Sequence-Models/tikz/RNN with Attention.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{chapters/07-Sequence-Models/tikz/Attention is Alignment 1.pdf}
\end{figure}

\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/07-Sequence-Models/tikz/Attention is Alignment 2.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/07-Sequence-Models/tikz/Local Attention Comparison.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/07-Sequence-Models/tikz/GNMT.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/07-Sequence-Models/tikz/Word2Vec Architecture.pdf}
