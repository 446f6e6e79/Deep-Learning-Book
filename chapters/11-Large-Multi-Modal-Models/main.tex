...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/Large Vision-Language Models.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/SimCLR.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/DINO.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/BEiT.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/MAE.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/CLIP.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/FLIP.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.6\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/ImageBind.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/STAIR Results.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.6\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/FILIP vs CLIP.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/CoCa.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/CLIP Architectures Recap 1.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/CLIP Architectures Recap 2.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/Frozen LM.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/Frozen LM Tasks 1.pdf}
    \caption{An example of Finetuning Frozen LM (1)}
\end{figure}

\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/Frozen LM Tasks 2.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/11-Large-Multi-Modal-Models/tikz/Flamingo Architecture.pdf}
