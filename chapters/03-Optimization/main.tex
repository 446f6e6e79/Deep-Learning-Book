...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{chapters/03-Optimization/tikz/BGD vs SGD vs SGD with Momentum.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{chapters/03-Optimization/tikz/Features Importance.pdf}
...
\includegraphics[width=\textwidth]{chapters/03-Optimization/tikz/Batch Norm.pdf}
...
\begin{minipage}{0.55\textwidth}
\includegraphics[width=\textwidth]{chapters/03-Optimization/tikz/Layer Norm.pdf}
...
\end{minipage}
\begin{minipage}{0.55\textwidth}
\includegraphics[width=\textwidth]{chapters/03-Optimization/tikz/Instance Norm.pdf}
