...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=1.4]{chapters/01-Feedforward-Neural-Networks/tikz/Feedforward Neural Network.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=2]{chapters/01-Feedforward-Neural-Networks/tikz/Sigmoid.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=2]{chapters/01-Feedforward-Neural-Networks/tikz/Hyperbolic Tangent.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=2]{chapters/01-Feedforward-Neural-Networks/tikz/ReLU.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=2]{chapters/01-Feedforward-Neural-Networks/tikz/Leaky ReLU.pdf}
    \caption{Leaky ReLU Activation Function Plot}
\end{figure}

\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=2]{chapters/01-Feedforward-Neural-Networks/tikz/ELU.pdf}
