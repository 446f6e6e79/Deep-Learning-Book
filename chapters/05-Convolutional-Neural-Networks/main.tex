...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/CNN.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/Convolution.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/Convolution with Padding.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/LeNet.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/AlexNet.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/Deconvolutional Networks.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.47\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/Deconvolutional Networks Captured Patterns}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/05-Convolutional-Neural-Networks/tikz/GradCam.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/VGGNet.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/GoogleNet.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/ResNet.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/05-Convolutional-Neural-Networks/tikz/R-CNN.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/Fast R-CNN.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/Faster R-CNN.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/05-Convolutional-Neural-Networks/tikz/YOLO.png}
