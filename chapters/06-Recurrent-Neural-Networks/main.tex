...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/06-Recurrent-Neural-Networks/tikz/Types of RNN Models.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width = 0.9\linewidth]{chapters/06-Recurrent-Neural-Networks/tikz/RNN Architecture.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/06-Recurrent-Neural-Networks/tikz/LSTM.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{chapters/06-Recurrent-Neural-Networks/tikz/GRU.pdf}
