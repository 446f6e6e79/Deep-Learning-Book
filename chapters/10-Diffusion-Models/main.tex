...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/10-Diffusion-Models/tikz/Diffusion Models Idea.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/10-Diffusion-Models/tikz/Generative Models Comparison.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/10-Diffusion-Models/tikz/Generative Trilemma.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/10-Diffusion-Models/tikz/Diffusion Models Network Architecture.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\linewidth]{chapters/10-Diffusion-Models/tikz/Stable Diffusion Architecture.pdf}
