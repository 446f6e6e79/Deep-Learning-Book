...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=2]{chapters/02-Backpropagation/tikz/Partial Derivatives.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=0.75]{chapters/02-Backpropagation/tikz/Gradient Descent.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=0.9]{chapters/02-Backpropagation/tikz/Local Minima.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=0.88]{chapters/02-Backpropagation/tikz/Saddle Point.pdf}
...
\includegraphics[width=\textwidth]{chapters/02-Backpropagation/tikz/Chain Rule One Layer.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{chapters/02-Backpropagation/tikz/Chain Rule Multiple Layer.pdf}
...
\end{minipage}
\begin{minipage}{0.45\textwidth}
\includegraphics[width=\textwidth]{chapters/02-Backpropagation/tikz/Chain Rule Multiple Layer Dependencies.pdf}
\captionof{figure}{Calculations with 3 Layers}
\end{minipage}

\begin{minipage}{0.4\textwidth}
\includegraphics[width=\textwidth]{chapters/02-Backpropagation/tikz/Indexing.pdf}
\captionof{figure}{Neural Network Indexing}
\vspace{0.8cm}
\includegraphics[width=\textwidth]{chapters/02-Backpropagation/tikz/Indexing Example.pdf}
